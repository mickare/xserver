...
public class BungeeXServerManager extends AbstractXServerManager {
	...
	protected BungeeXServerManager( String servername, BungeeXServerPlugin bungeePlugin, MySQL connection,
