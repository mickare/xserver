...
public class PackageCommand extends SubCommand {
  ...
  private StringBuilder appendHeaderLine(StringBuilder sb) {
    sb.append(ChatColor.GRAY).append("Packages per second\n").append("Name  ").append("Sending").append(":").append("Receiving")
        .append(" (").append("RecordSending").append(":").append("RecordReceiving").append(")");
    return sb;
  }
  ...
  private StringBuilder appendSpeedLine(StringBuilder sb, XServer s) {
    ...
    if (s.isConnected()) {
      ...
      sb.append(ChatColor.GOLD).append(s.getSendinglastSecondPackageCount()).append(ChatColor.GRAY).append(":").append(ChatColor.GOLD)
          .append(s.getReceivinglastSecondPackageCount())

      .append(ChatColor.GRAY).append("  (").append(ChatColor.AQUA).append(s.getSendingRecordSecondPackageCount()).append(ChatColor.GRAY)
          .append(":").append(ChatColor.AQUA).append(s.getReceivingRecordSecondPackageCount()).append(ChatColor.GRAY).append(")");
    } else {
